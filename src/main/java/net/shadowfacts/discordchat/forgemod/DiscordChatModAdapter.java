 ...
 * @author shadowfacts
 */
public class DiscordChatModAdapter implements IMinecraftAdapter {
	...
	public long getWorldTime(int dimension) {
		return FMLCommonHandler.instance().getMinecraftServerInstance().getWorld(dimension).getWorldTime();
	}
